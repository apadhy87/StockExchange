...
public class StockPriceController {
	...
	public ResponseEntity<StockPriceDetailsDTO> addStockDetails(@Valid @RequestBody StockPriceDetailsDTO stockPriceDetailsDTO, BindingResult bindingResult) throws InvalidStockException {
		...
		StockPriceDetailsDTO stockPriceDetailDTO=stockMarketService.saveStockPriceDetails(stockPriceDetailsDTO);
		return new ResponseEntity<StockPriceDetailsDTO>(stockPriceDetailDTO,new HttpHeaders(),HttpStatus.OK);
	}
	//-------------------------------------------------------------------------------------------------------------------------------
	...
	public ResponseEntity<List<StockPriceDetailsDTO>> deleteStockByCompanyCode(@PathVariable Long companyCode) {
		List<StockPriceDetailsDTO> listStockPriceDetailsDTO=stockMarketService.deleteStock(companyCode);
		 return new ResponseEntity<List<StockPriceDetailsDTO>>(listStockPriceDetailsDTO,new HttpHeaders(),HttpStatus.OK);
	}
	//-------------------------------------------------------------------------------------------------------------------------------
